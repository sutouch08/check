...
{
  public $menu_code = "ICCHECK";
  public $menu_group_code = "IC";
  public $title = "การตรวจนับ";
  public $segment = 4;
  ...
  public function add()
  {
    ...
    $zone = $this->shop_model->get_by_code($zone_code);
    ...
    if( ! empty($zone))
    {
      $arr = array(
        ...
        'is_consignment' => $zone->is_consignment,
        'start_date' => now(),
        'status' => 'O',
        'allow_input_qty' => $zone->allow_input_qty,
        'date_add' => $date_add,
  ...
  public function get_new_code($date = NULL)
  {
    ...
    $prefix = getConfig('PREFIX_CHECK');
    $run_digit = getConfig('RUN_DIGIT_CHECK');
    $pre = $prefix .'-'.$Y.$M;
