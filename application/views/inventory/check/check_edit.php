...
<div class="row">
  ...
  <div class="col-lg-3 col-md-3 col-sm-8 col-xs-6 padding-5">
    <label>หัวข้อ</label>
    <input type="text" class="form-control input-sm" name="subject" id="subject" value="<?php echo $doc->subject; ?>" />
  </div>

  <div class="col-lg-2 col-md-2 col-sm-3 col-xs-6 padding-5">
    <label>โซน</label>
    <input type="text" class="form-control input-sm" name="zone_code" id="zone_code" value="<?php echo $doc->zone_code; ?>" />
  </div>
  ...
  <div class="col-lg-10-harf col-md-10-harf col-sm-10-harf col-xs-9 padding-5">
    ...
    <input type="text" class="form-control input-sm" name="remark" id="remark" value="<?php echo $doc->remark; ?>" />
  </div>
  <div class="col-lg-1-harf col-md-1-harf col-sm-1-harf col-xs-3 padding-5">
    <label class="display-block not-show">btn</label>
    <button type="button" class="btn btn-xs btn-success btn-block" onclick="update()"><i class="fa fa-plus"></i> Update</button>
  </div>
