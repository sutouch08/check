...
<div class="row">
  <div class="col-lg-1 col-md-1 col-sm-1-harf col-xs-3 padding-5">
    <input type="number" class="form-control input-sm text-center" name="qty" id="qty" value="1" placeholder="Qty" <?php echo $disabled; ?>/>
  </div>

  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 padding-5">
    <input type="text" class="form-control input-sm text-center" name="barcode" id="barcode" placeholder="แสกนบาร์โค้ดเพื่อตรวจนับ"autofocus />
  </div>
  ...
  <div class="col-lg-1-harf col-md-2 col-sm-2 col-xs-6">
    <button type="button" class="btn btn-xs btn-warning btn-block" onclick="inputView()">เรียกดูรายการล่าสุด</button>
  </div>
