...
<div class="row">
	...
	<div class="row">
		...
		<div class="form-group">
			...
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 padding-5">
				<input type="text" name="warehouse_code" id="warehouse_code" class="width-100" maxlength="8" value="" onkeyup="validCode(this)" />
			</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 padding-5">
				<input type="text" name="warehouse_name" id="warehouse_name" class="width-100" maxlength="100" value="" />
			</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 padding-5">
				<label style="padding-top:5px;">
					<input name="allow_input_qty" id="allow_input_qty" class="ace ace-switch ace-switch-7" type="checkbox" value="1" />
					<span class="lbl"></span>
				</label>
			</div>
    ...
    <div class="divider-hidden"></div>
		...
		<div class="form-group">
			<label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label no-padding-right not-show">Add</label>
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 padding-5">
