...
<div class="row">
	...
	<div class="row">
		<div class="form-group">
			...
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 padding-5">
				<input type="text" name="code" id="code" class="width-100" maxlength="50" value="<?php echo $pd->code; ?>" onkeyup="validCode(this)" />
			</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 padding-5">
				<input type="text" name="name" id="name" class="width-100" maxlength="100" value="<?php echo $pd->name; ?>" required />
			</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 padding-5">
				<input type="text" name="style" id="style" maxlength="50" class="width-100" value="<?php echo $pd->style; ?>" required />
			</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 padding-5">
				<input type="text" name="barcode" id="barcode" maxlength="50" class="width-100" value="<?php echo $pd->barcode; ?>" />
			</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-1-harf col-md-1-harf col-sm-2 col-xs-6 padding-5">
				<input type="number" step="any" name="cost" id="cost" class="width-100" value="<?php echo $pd->cost; ?>" />
			</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-1-harf col-md-1-harf col-sm-2 col-xs-6 padding-5">
				<input type="number" step="any" name="price" id="price" class="width-100" value="<?php echo $pd->price; ?>"  />
			</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 padding-5">
				<label style="padding-top:5px;">
					<input name="active" id="active" class="ace ace-switch ace-switch-7" type="checkbox" value="1" <?php echo is_checked($pd->active, '1'); ?> />
					<span class="lbl"></span>
				</label>
			</div>
    ...
    <div class="divider-hidden"></div>
		...
		<input type="hidden" id="product_id" value="<?php echo $pd->id; ?>"/>
	</div>
	</form>
</div><!--/ row  -->
